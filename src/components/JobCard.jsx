...
export default function JobCard({ job, index }) {
  ...
  const autoFill    = getAutoFillData(candidate);
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
                    ...
                    <button
                      ...
                      style={{
                        padding: "10px 12px",
                        background: applied ? "rgba(34,197,94,.15)" : "var(--bg3)",
                        border: `1px solid ${applied ? "#22c55e" : "var(--border)"}`,
                        color: applied ? "#22c55e" : "var(--text2)",
            ...
            {tab === "cover" && (
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                  <div>
                    <h4 style={{ fontSize: 14, fontWeight: 600 }}>AI-Generated Cover Letter</h4>
